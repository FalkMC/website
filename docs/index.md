...
<div class="falkmc-hero">
  ...
  <div class="hero-dash">
    <img src="/images/dashboard.png" alt="FalkMC Panel Dashboard" class="dash-mockup" />
  </div>
</div>
...
<div class="feature-grid">
  <div class="feature-card">
    <div class="feature-icon">
      <svg viewBox="0 0 24 24" width="28" height="28" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="6" rx="2"/><rect x="3" y="14" width="18" height="6" rx="2"/></svg>
    </div>
    <h3>Server list</h3>
    <p>See every server you've created in one place, with status shown at a glance.</p>
  </div>
  <div class="feature-card">
    <div class="feature-icon">
  ...
  <div class="feature-card">
    <div class="feature-icon">
      <svg viewBox="0 0 24 24" width="28" height="28" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M2 12h20"/></svg>
    </div>
    <h3>One‑click setup</h3>
    <p>Vanilla installs itself, pick a version and FalkMC handles the rest.</p>
  </div>
  <div class="feature-card">
    <div class="feature-icon">
...
<div class="roadmap">
  ...
  <div class="road-card active">
    ...
    <ul>
      ...
      <li>Live console &amp; logging</li>
      <li>Manual &amp; scheduled backups</li>
    </ul>
  </div>
  <div class="road-card">
    <div class="road-dot"></div>
    ...
    <ul>
      <li>Network &amp; port management</li>
      <li>Plugin &amp; mod manager</li>
      <li>Theme &amp; UI polish</li>
    </ul>
  </div>
  <div class="road-card">
    <div class="road-dot"></div>
